...
def draw_player_stats(output_video_frames, player_stats):
    ...
    for index, row in player_stats.iterrows():
        ...
        player_3_shot_speed = row['player_3_last_shot_speed']
        player_1_speed = row['player_1_last_player_speed']
        player_3_speed = row['player_3_last_player_speed']

        avg_player_1_shot_speed = row['player_1_average_shot_speed']
        avg_player_3_shot_speed = row['player_3_average_shot_speed']
        avg_player_1_speed = row['player_1_average_player_speed']
        avg_player_3_speed = row['player_3_average_player_speed']
        ...
        text = f"{player_1_shot_speed:.1f} km/h    {player_3_shot_speed:.1f} km/h"
        ...
        text = f"{player_1_speed:.1f} km/h    {player_3_speed:.1f} km/h"
        ...
        text = f"{avg_player_1_shot_speed:.1f} km/h    {avg_player_3_shot_speed:.1f} km/h"
        ...
        text = f"{avg_player_1_speed:.1f} km/h    {avg_player_3_speed:.1f} km/h"
